...
"Type               : GBRF¥r¥n¥
Bank ROM Num       : %XH¥r¥n¥
Bank ROM(0000-3FFF): %XH¥r¥n¥
Bank ROM(4000-7FFF): %XH¥r¥n¥
Init Address       : %04XH¥r¥n¥
VSync Address      : %04XH¥r¥n¥
Timer Address      : %04XH¥r¥n¥
Interrupt Flag     : %s%s¥r¥n¥
GBC Flag(2x Speed) : %d¥r¥n¥
First TMA          : %02XH¥r¥n¥
First TMC          : %02XH"
